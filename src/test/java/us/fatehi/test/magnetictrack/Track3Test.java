...
public class Track3Test {
  ...
  public void track3__1() {
    final String track3Data = "+6202608082356005=15046200000010000000000004976?";
  ...
  public void track3__2() {
    final String track3Data =
        "%B378578692630345^ /                        ^1508121140165241?;378578692630345=150812114016524100000?+6202608082356005=15046200000010000000000004976?";
    final Track3 track3 = Track3.from(track3Data);
    checkCardData(track3);
  }

  private void checkCardData(final Track3 track3) {
    assertThat(track3.getRawData(), is("+6202608082356005=15046200000010000000000004976?"));
    assertThat(track3.toString(), is(track3.getRawData()));
    assertThat(track3.getDiscretionaryData(), is("6202608082356005=15046200000010000000000004976"));
