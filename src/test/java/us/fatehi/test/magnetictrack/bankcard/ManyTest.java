...
import us.fatehi.magnetictrack.bankcard.MagneticStripeBankCard;
...
public class ManyTest
{
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackA.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackB.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackC.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackD.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackE.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackF.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackG.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackH.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackI.toBankCard();
    ...
    throws Exception
  {
    ...
    final MagneticStripeBankCard cardInfo = trackJ.toBankCard();
