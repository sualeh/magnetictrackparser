...
public class ManyTest
{
  ...
  public void trackA()
    throws Exception
  {
    final BankCardMagneticTrack trackA = BankCardMagneticTrack.from(
    ...
    assertThat(cardInfo.getExpirationDate().getExpirationDate(),
               is(YearMonth.of(2016, 4)));
  }
  ...
  public void trackB()
    throws Exception
  {
    final BankCardMagneticTrack trackB = BankCardMagneticTrack.from(
  ...
  public void trackC()
    throws Exception
  {
    final BankCardMagneticTrack trackC = BankCardMagneticTrack.from(
  ...
  public void trackD()
    throws Exception
  {
    final BankCardMagneticTrack trackD = BankCardMagneticTrack.from(
    ...
    assertThat(cardInfo.getPrimaryAccountNumber().getAccountNumber(),
               is("6011460477609366"));
    assertThat(cardInfo.getPrimaryAccountNumber().getCardBrand(),
               is(CardBrand.Discover));
    assertThat(cardInfo.getName().toString(), is("Sualeh Fatehi"));
    assertThat(cardInfo.getExpirationDate().getExpirationDate(),
               is(YearMonth.of(2015, 10)));
  }
  ...
  public void trackE()
    throws Exception
  {
    final BankCardMagneticTrack trackE = BankCardMagneticTrack.from(
  ...
  public void trackF()
    throws Exception
  {
    final BankCardMagneticTrack trackF = BankCardMagneticTrack.from(
  ...
  public void trackG()
    throws Exception
  {
    final BankCardMagneticTrack trackG = BankCardMagneticTrack.from(
    ...
    assertThat(cardInfo.getPrimaryAccountNumber().getAccountNumber(),
               is("379580832431161"));
    assertThat(cardInfo.getPrimaryAccountNumber().getCardBrand(),
               is(CardBrand.AmericanExpress));
    assertThat(cardInfo.getName().toString(), is(""));
    assertThat(cardInfo.getExpirationDate().getExpirationDate(),
               is(YearMonth.of(2015, 8)));
  }
  ...
  public void trackH()
    throws Exception
  {
    final BankCardMagneticTrack trackH = BankCardMagneticTrack.from(
