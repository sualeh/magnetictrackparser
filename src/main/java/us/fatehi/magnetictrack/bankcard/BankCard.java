...
implements Serializable
{
  ...
  /**
   * @return
   * @see us.fatehi.magnetictrack.bankcard.PrimaryAccountNumber#getAccountNumber()
   */
  ...
  /**
   * @see us.fatehi.magnetictrack.bankcard.Name#getFullName()
   */
  ...
  /**
   * @see us.fatehi.magnetictrack.bankcard.ExpirationDate#getExpirationDateAsDate()
   */
